...
<body>
	...
	<!-- POST DELETE SUCCESS/FAIL ALERT -->
	...
	<!-- WRITE REPLY SUCCESS/FAIL ALERT -->
	...
	<table>
		<tr>
			...
			<th>글쓴이</th><th>글제목</th><th>작성일</th><th>조회순</th>
		</tr>
		<c:if test="${totCnt eq 0 }">
			<tr>
				<th colspan="7">Currently, there are no posts</th>
			</tr>
		</c:if>
		<c:if test="${totCnt != 0 }">
			<c:forEach items="${boardList }" var="bDto">
				<tr onclick="trclicked(${bDto.bid })">
					...
					<%-- 	<fmt:formatDate value="${bDto.date }" pattern="yy/MM/dd(E) hh:mm:ss(a)"/> DATE DOES NOT PRINT THE CORRECT TIME--%>
					</td>
					<td>
