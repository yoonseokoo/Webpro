...
public class BookMain {
	public static void main(String[] args) {
		...
		int fn;
		int idx;
		String btitle, borrower, checkOutDate, cNo;
				...
				case 1 :
					...
					if (idx == books.length) {
						...
						if (books[idx].getState() == BookLib.STATE_BORROWED) {
							...
							// System.out.println(
							// "If you would like to borrow the corresponding CD
							// press 1 otherwise 0. ");
							// cNo = scanner.next();
							// if(cNo == "1") {
							// for (idx = 0; idx < books.length; idx++) {
							// if (cNo.equals(books[idx].getCd())) {
							// break;
							// }
							// }
							// if (idx == books.length) {
							...
							// } else {
							//
							// if (books[idx].getCdState() ==
							// CdLib.STATE_BORROWED) {
							...
							// books[idx].checkOut(borrower, checkOutDate);
							// System.out.println(
							// "Would you like to borrow the corresponding CD?:
							// ");
							// ctitle = scanner.next();
							// for (idx = 0; idx < books.length; idx++) {
							// if (ctitle.equals(books[idx].getBookNo())) {
							// break;
							// }
						}
						break;
