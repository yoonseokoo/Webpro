...
<body>
	...
	<table>
		...
		<tr>
			<th>작성일</th>
			<td><fmt:formatDate value="${content_view.bdate }" pattern="yy/MM/dd(E)"/>
		</tr>
		<tr>
			<th>IP</th>
		...
		<tr>
			<td colspan="2">
				...
				<button onclick="location='${conPath }/list.do?bid=${param.bid }&pageNum=${param.pageNum }'">목록</button>
