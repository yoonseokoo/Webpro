...
import com.lec.dto.Review_comment_dto;
import com.lec.dto.Review_dto;
...
public class Review_dao {
	...
	public boolean reviewWrite(String pcode, String mid, String rimage1, String rimage2, String rimage3, int rstar,
			String rcontent) {
	...
	public boolean reviewModify(String pcode, String rimage1, String rimage2, String rimage3, int rstar,
			String rcontent, int rno) {
		boolean result = false;
	...
	public ArrayList<Review_dto> getReviewListAll(int startRow, int endRow) {
		...
		try {
			...
			while (rs.next()) {
				...
				rListAll.add(new Review_dto(rno, pcode, pname, mid, rimage1, rimage2, rimage3, rgood, rstar, rcontent,
						rdate, rcexist));
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
	...
	public ArrayList<Review_dto> getReviewListProduct(String pcode, int startRow, int endRow) {
		...
		try {
			...
			while (rs.next()) {
				...
				Date rdate = rs.getDate("rdate");
				boolean rcexist = rs.getInt("rcexist") == 1; // 1이 true
				rListProduct.add(new Review_dto(rno, pcode, pname, mid, rimage1, rimage2, rimage3, rgood, rstar,
						rcontent, rdate, rcexist));
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
