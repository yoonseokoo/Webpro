...
public class Product_dao {
	...
	public boolean registProduct(String pcode, String mgid, String pname, int pprice, String pimage, int pstock,
			String pdescription, int pdiscount) {
	...
	private ArrayList<Product_dto> getProductListSQL(int startRow, int endRow, String sql, String searchPname) {
		...
		try {
			...
			while (rs.next()) {
				...
				products.add(new Product_dto(pcode, pname, pprice, pimage, pstock, pdescription, pdiscount, pregist,
						pcumulative_sales, prating, preview_count, mgname));
			}
		} catch (SQLException e) {
	...
	public Product_dto[] getProductTOPN(int n) {
		...
		try {
			...
			for (int i = 0; i < n; i++) {
				...
				double prating = rs.getDouble("prating");
				String mgname = rs.getString("mgname");
				products[i] = new Product_dto(pcode, pname, pprice, pimage, pstock, pdescription, pdiscount, pregist,
						pcumulative_sales, prating, preview_count, mgname);
			}
		} catch (SQLException e) {
	...
	public Product_dto productDetail(String pcode) {
		...
		try {
			...
			if (rs.next()) {
				...
				double prating = rs.getDouble("prating");
				String mgname = rs.getString("mgname");
				product = new Product_dto(pcode, pname, pprice, pimage, pstock, pdescription, pdiscount, pregist,
						pcumulative_sales, prating, preview_count, mgname);
			}
		} catch (SQLException e) {
	...
	public boolean modifyProduct(String pname, int pprice, String pimage, int pstock, String pdescription,
			int pdiscount, String pcode) {
		boolean result = false;
