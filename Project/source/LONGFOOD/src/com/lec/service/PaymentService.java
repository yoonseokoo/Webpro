...
import com.lec.dao.Payment_dao;
...
public class PaymentService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int cono = -1;
		if (!conoStr.equals("") && !conoStr.equals("NaN"))
			cono = Integer.parseInt(conoStr);
		String couponDiscountStr = request.getParameter("couponDiscount");
		if (!couponDiscountStr.equals("") && !couponDiscountStr.equals("NaN"))
		...
		if (productPurchase && mPointMinus && mcumulative_buy_plus && mPointPlus) {
			request.setAttribute("pbuyNowResult",
					"주문 성공하셨습니다. 주문금액 : " + purchase_amount + "원 포인트 " + mpoint + "점 적립되었습니다.");
