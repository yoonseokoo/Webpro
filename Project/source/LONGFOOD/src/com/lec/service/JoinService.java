...
public class JoinService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if (ad_email_str == null)
			ad_email = 0;
		if (ad_phone_str == null)
			ad_phone = 0;
		if (ad_call_str == null)
			ad_call = 0;
		...
		request.setAttribute("joinResult",
				mDao.joinMember(mid, mpw, mname, mphone, maddress_basic, maddress_detail, mbirth, memail, mgender));
	}
