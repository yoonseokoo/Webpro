...
public class GroupsController {
	...
	public String groupInfo(int gid, Model model, String mid) {
		...
		/*
		 * model.addAttribute("sesionGBgid", gid); model.addAttribute("sesionGBmid",
		 * mid); model.addAttribute("grouplist",
		 * groupBoardService.listLatest20Groupboard(gid, mid));
		 */
	...
	@RequestMapping(value="modify", method = RequestMethod.POST)
		public String modify(MultipartHttpServletRequest mRequest, @ModelAttribute("gDto") Groups groups, Model model, String pageNum, int gid, String [] fids, HttpSession session) {
		...
		return "forward:../groups/groupInfo.do?gid="+gid;
	}
	...
	public String deleteGroup(int gid) {
		...
		return "forward:../groups/groupList.do";
}
