...
<link href="${conPath}/css/groups/groupBoard.css" rel="stylesheet">
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script>
      $(document).ready(function(){
         /* 대화입력창 포커스 */
         $('#chattingBoardWarp #chattingBoardInsert #tempGbcontent').focus();
         var sessionGid = ${gbGid}; /*세션 gid셋팅*/
         /* 스크롤 아래로 시작 */
   ...
   <div id="chatting">
      <div id="chattingBoardWarp">
         <div id="chattingHeaderBar">
            <p>'${gbGid }' Group Board</p>
            <p id="currentMemebers"></p>
         </div>

         <div id="chattingBoardList" style="overflow: auto; height: 57%; width: 93%;">
            <!-- 과거대화 출력 -->
         ...
         <div id="chattingBoardInsert">
            <!-- 대화 입력 -->
            <input type="hidden" name="gid" value="${gbGid}" id="tempGid">
            <input type="hidden" name="mid" value="${sessionGBmid}" id="tempMid">
            <table>
               <tr>
                  <td>
                  ...
                  <td>
                     <img id="insertGroupBoard" src="${conPath }/groupFileBoardUploadFiles/pngegg.png"
                         width="50" height="40">
                  </td>
               </tr>
            </table>
