	...
	<table class="type06">
	    ...
	    <c:forEach items="${allNotification }" var="notification">
	      ...
	      <c:if test="${notification.notcheck eq 0 }">
	      	<td class="uncheck" style="background: rgba(0, 0, 0, 0.25);"><b style="color:red;">*</b><strong style="color: #1DBF73;">${notification.notsender }</strong><b>${notification.notcontent }</b><br><i><fmt:formatDate value="${notification.notdate }" pattern="M월dd일(EE)"/></i></td>
	      </c:if>
