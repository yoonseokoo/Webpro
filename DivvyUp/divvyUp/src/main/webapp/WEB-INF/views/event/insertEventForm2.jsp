	...
	<div id="totalWrap">
		<div id="content">
			<form
				...
				<input type="hidden" name="mid" value="${member.mid }" class="mid">
				<table>
					<tr>
						<td colspan="2"
					...
					<tr>
						...
						<td><textarea name="econtent" rows="6"
								style=" padding:5px; border: 0.5px solid lightgrey; outline: none; text-align: center;"></textarea></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><input type="submit" value="지출입력"
							...
							onclick="location='${conPath }/groups/groupInfo.do?gid=${param.gid }&mid=${member.mid}'" class="btn_style"></td>
					</tr>
				</table>
			</form>
