...
public class EventController {
	...
	public String insertEvent(MultipartHttpServletRequest mRequest, @ModelAttribute("eDto") Event event,  HttpSession httpSession, Model model) {
		model.addAttribute("insertEvent", eventService.insertEvent(event, mRequest));
		return "redirect:eventDetail.do?method=insertEventDetail";
	}
